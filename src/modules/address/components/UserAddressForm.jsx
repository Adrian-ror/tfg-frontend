...
import {addUserAddress} from "../../../backend/addressService.js";
...
const UserAddressForm = () => {
    ...
    const handleSubmit = (event) => {
        ...
        addUserAddress(formData,
            () => handleSuccess("Added!", '/users/addresses'),
            ...
            <div className="mx-auto bg-gray-100 shadow-lg rounded-lg p-8 w-full max-w-lg border">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button
                            type="submit"
                            className="w-full rounded-md bg-yellow-600 hover:bg-yellow-700 py-3 px-6 text-base font-semibold text-white outline-none"
                        >
                            Add Address
                        </button>
                    </div>
