...
export default {
    ...
    'project.app.Footer.text': 'Proyecto TFG - Area de Ingeniería Telemática - Universidad de A Coruña',
    'project.app.Header.home': 'Inicio',
    'project.app.Header.logout': 'Salir',
    'project.app.Home.welcome': 'Bienvenido a la aplicación de ejemplo de TFG',
